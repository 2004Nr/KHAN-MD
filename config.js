...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "IK~YOcUybqR#fVncs2d_erkmNlrzdbXkPXO1wodpSsuoFQAnMVlMnK8",
// add your Session Id
...
STICKER_NAME: process.env.STICKER_NAME || "🚷 --≺⎠-"Ｎａｖｏｄ"-⎝≻--❗♥",
...
OWNER_NUMBER: process.env.OWNER_NUMBER || "94725702991",
// add your bot owner number
OWNER_NAME: process.env.OWNER_NAME || "🚷 --≺⎠-"Ｎａｖｏｄ"-⎝≻--❗♥",
// add bot owner name
